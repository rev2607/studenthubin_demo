...
namespace StudentHubMVC
{
    ...
    public partial class Colleges
    {
        ...
        public Colleges()
        {
            ...
            this.shub_collegeimages = new HashSet<CollegeImages>();
        }
        ...
        public virtual DropdownTypes CollegeTypeDropdownTypes { get; set; }
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<CollegeImages> shub_collegeimages { get; set; }
    }
}
