...
(function($) {
    ...
    STUDENTHUB.isMobile = {
        ...
        any: function() {
            return (STUDENTHUB.isMobile.Android() || STUDENTHUB.isMobile.BlackBerry() || STUDENTHUB.isMobile.iOS() || STUDENTHUB.isMobile.Opera() || STUDENTHUB.isMobile.Windows());
        }
    };
    ...
    STUDENTHUB.bmiCalculator = {
        ...
        calculateStandard: function (bmi_form) {
            ...
            var output = STUDENTHUB.bmiCalculator.magic(bmi);
        ...
        init: function () {
            ...
            bmi_Standard_Form.on('submit', function(e) {
                e.preventDefault();
                STUDENTHUB.bmiCalculator.calculateStandard(bmi_Standard_Form);
                return false;
            });
            ...
            bmi_Metric_Form.on('submit', function(e) {
                e.preventDefault();
                STUDENTHUB.bmiCalculator.calculateMetric(bmi_Metric_Form);
                return false;
            });
        }
    ...
    STUDENTHUB.initialize = {
        ...
        init: function() {
            STUDENTHUB.bmiCalculator.init();
            STUDENTHUB.initialize.TM_toggleNavSearchIcon();
            STUDENTHUB.initialize.TM_fixedFooter();
            STUDENTHUB.initialize.TM_datePicker();
            STUDENTHUB.initialize.TM_ddslick();
            STUDENTHUB.initialize.TM_sliderRange();
            STUDENTHUB.initialize.TM_loadBSParentModal();
            STUDENTHUB.initialize.TM_demoSwitcher();
            STUDENTHUB.initialize.TM_platformDetect();
            STUDENTHUB.initialize.TM_onLoadPopupPromoBox();
            STUDENTHUB.initialize.TM_customDataAttributes();
            STUDENTHUB.initialize.TM_parallaxBgInit();
            STUDENTHUB.initialize.TM_resizeFullscreen();
            STUDENTHUB.initialize.TM_prettyPhoto_lightbox();
            STUDENTHUB.initialize.TM_nivolightbox();
            STUDENTHUB.initialize.TM_fitVids();
            STUDENTHUB.initialize.TM_YTPlayer();
            STUDENTHUB.initialize.TM_equalHeightDivs();
        },
        ...
        TM_parallaxBgInit: function() {
            if (!STUDENTHUB.isMobile.any() && $window.width() >= 800 ) {
    ...
    STUDENTHUB.header = {
        ...
        init: function() {
            ...
            var t = setTimeout(function() {
                STUDENTHUB.header.TM_fullscreenMenu();
                STUDENTHUB.header.TM_sidePanelReveal();
                STUDENTHUB.header.TM_sidePushPanelContent();
                STUDENTHUB.header.TM_scroolToTopOnClick();
                STUDENTHUB.header.TM_scrollToFixed();
                STUDENTHUB.header.TM_sticky();
                STUDENTHUB.header.TM_topnavAnimate();
                STUDENTHUB.header.TM_scrolltoTarget();
                STUDENTHUB.header.TM_navLocalScorll();
                STUDENTHUB.header.TM_menuCollapseOnClick();
                STUDENTHUB.header.TM_homeParallaxFadeEffect();
                STUDENTHUB.header.TM_topsearch_toggle();
            }, 0);
    ...
    STUDENTHUB.widget = {
        ...
        init: function() {
            ...
            var t = setTimeout(function() {
                STUDENTHUB.widget.TM_shopClickEvents();
                STUDENTHUB.widget.TM_fcCalender();
                STUDENTHUB.widget.TM_verticalTimeline();
                STUDENTHUB.widget.TM_verticalMasonryTimeline();
                STUDENTHUB.widget.TM_masonryIsotop();
                STUDENTHUB.widget.TM_pieChart();
                STUDENTHUB.widget.TM_progressBar();
                STUDENTHUB.widget.TM_funfact();
                STUDENTHUB.widget.TM_odometerFunfact();
                STUDENTHUB.widget.TM_instagramFeed();
                STUDENTHUB.widget.TM_jflickrfeed();
                STUDENTHUB.widget.TM_accordion_toggles();
                STUDENTHUB.widget.TM_tooltip();
                //STUDENTHUB.widget.TM_countDownTimer();
            }, 0);
        ...
        TM_masonryIsotop: function() {
            ...
            STUDENTHUB.slider.TM_flexslider();
    ...
    STUDENTHUB.slider = {
        ...
        init: function() {
            ...
            var t = setTimeout(function() {
                STUDENTHUB.slider.TM_typedAnimation();
                STUDENTHUB.slider.TM_flexslider();
                STUDENTHUB.slider.TM_owlCarousel();
                STUDENTHUB.slider.TM_maximageSlider();
                STUDENTHUB.slider.TM_bxslider();
                STUDENTHUB.slider.TM_beforeAfterSlider();
            }, 0);
        ...
        TM_flexslider: function() {
            ...
            if ( $each_flex_slider.length > 0 ) {
                STUDENTHUB.widget.TM_portfolioFlexSliderGalleryPopUpInit();
                $each_flex_slider.each(function() {
                    ...
                    $flex_slider.flexslider({
                        ...
                        start: function(slider){
                            ...
                            STUDENTHUB.initialize.TM_magnificPopup_lightbox();
                            STUDENTHUB.initialize.TM_prettyPhoto_lightbox();
                            STUDENTHUB.initialize.TM_nivolightbox();
                        },
                        after: function(){
    ...
    /* ---------------------------------------------------------------------- */
    //document ready
    STUDENTHUB.documentOnReady = {
        init: function() {
            STUDENTHUB.initialize.init();
            STUDENTHUB.header.init();
            STUDENTHUB.slider.init();
            STUDENTHUB.widget.init();
            STUDENTHUB.windowOnscroll.init();
        }
    };

    //window on load
    STUDENTHUB.windowOnLoad = {
        init: function() {
            var t = setTimeout(function() {
                STUDENTHUB.initialize.TM_wow();
                STUDENTHUB.widget.TM_twittie();
                STUDENTHUB.initialize.TM_magnificPopup_lightbox();
                STUDENTHUB.initialize.TM_preLoaderOnLoad();
                STUDENTHUB.initialize.TM_hashForwarding();
                STUDENTHUB.initialize.TM_parallaxBgInit();
            }, 0);
    ...
    //window on scroll
    STUDENTHUB.windowOnscroll = {
        init: function() {
            $window.on( 'scroll', function(){
                STUDENTHUB.header.TM_scroolToTop();
                STUDENTHUB.header.TM_activateMenuItemOnReach();
                STUDENTHUB.header.TM_topnavAnimate();
            });
        }
    };
    ...
    STUDENTHUB.header.TM_menuzord();

    /* ---------------------------------------------------------------------- */
    /* ---------------------------- Call Functions -------------------------- */
    /* ---------------------------------------------------------------------- */
    $document.ready(
        STUDENTHUB.documentOnReady.init
    );
    $window.on('load',
        STUDENTHUB.windowOnLoad.init
    );
    $window.on('resize', 
        STUDENTHUB.windowOnResize.init
    );

    //call function before document ready
    STUDENTHUB.initialize.TM_preLoaderClickDisable();
