...
@Component({
  selector: 'app-results-ap-inter-firstyear-vocational',
  templateUrl: './results-ap-inter-firstyear-vocational.component.html',
  styleUrls: ['../resultscss/responsive-page.css','../resultscss/result-details.css']
})
export class ResultsApInterFirstYearVocationalComponent extends BaseResultsComponent
implements OnInit {
