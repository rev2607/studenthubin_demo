...
@Component({
  selector: 'app-results-ap-inter-secondyear-regular',
  templateUrl: './results-ap-inter-secondyear-regular.component.html',
  styleUrls: ['../resultscss/responsive-page.css','../resultscss/result-details.css']
})
export class ResultsApInterSecondYearRegularComponent extends BaseResultsComponent
implements OnInit {
