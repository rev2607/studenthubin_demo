...
@Component({
  selector: 'app-results-ap-inter-secondyear-vocational',
  templateUrl: './results-ap-inter-secondyear-vocational.component.html',
  styleUrls: ['../resultscss/responsive-page.css','../resultscss/result-details.css']
})
export class ResultsApInterSecondYearVocationalComponent extends BaseResultsComponent
implements OnInit {
